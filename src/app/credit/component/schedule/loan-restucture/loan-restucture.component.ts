...
@Component({
  selector: 'app-loan-restucture',
  templateUrl: './loan-restucture.component.html',
})
export class LoanRestuctureComponent implements OnInit {
 checked: boolean ;
    ...
    ngOnInit() {
        this.onscheduleMethodChanged(this.loanData.scheduleTypeId)
        ...
        this.scheduleGroupForm.controls['interestFrequency'].setValue(this.loanData.interestFrequencyTypeId);
        this.scheduleGroupForm.controls['principalfrequency'].setValue(this.loanData.principalFrequencyTypeId);
        this.scheduleGroupForm.controls['principalFirstDate'].setValue(new Date(this.loanData.firstPrincipalPaymentDate));
        this.scheduleGroupForm.controls['intrestFirstDate'].setValue(new Date(this.loanData.firstInterestPaymentDate));
        this.scheduleGroupForm.controls['maturityDate'].setValue(new Date(this.loanData.maturityDate));
        this.scheduleGroupForm.controls['basis'].setValue(this.loanData.accrualBasis);
        this.scheduleGroupForm.controls['loanDate'].setValue(new Date(this.loanData.effectiveDate));
        // this.scheduleGroupForm.controls['principalAmount'].setValue(this.loanData.outstandingPrincipal)
        // this.data.loanDate = new Date(this.loanData.effectiveDate);
    ...
    public _loanAmount = 0;
        ...
        set loanAmount(loanAmount: number) {
            ...
            if(loanAmount >0){
                ...
                // this.scheduleGroupForm.controls['principalAmount'].setValue(this.loanAmount);
               // this.onPrincipalblur();
            }
        }
        get loanAmount(): number { return this._loanAmount; }
    ...
    getDayCount() {
        this.loanScheduleService.getAllDayCount()
            .subscribe((res) => {
    ...
    calculateMaturityDate(){
        if(this.data.tenor <= 0){
            ...
            var maturityDate = this.dateUtilService
            .dateAdd(this.scheduleGroupForm.value.loanDate,'day',this.data.tenor);
    ...
    getFrequencyTypes() {
        this.loanScheduleService.getAllFrequencyTypes()
            .subscribe((res) => {
    ...
    validateOnBackdate(){
        ...
        {
            swal.fire("GOS FINANCIAL", "Loan Schedule Generation', 'Schedule back-dating detected! \n' + 'Note: this loan will when booked will not be disbursed', 'info", "success");
            this.checked = true;
    ...
    addToList() {
        ...
        this.principalBalance = (Number(this.principalBalance) - Number(pmts.payAmount));
        this.principalValanceString = this.principalBalance.toLocaleString('en-US', { minimumFractionDigits: 2 });
    ...
    generateIrregularSchedule() {
        ...
        let body = {
            ...
            effectiveDate: new Date(this.data.loanDate),
        ...
        this.loanScheduleService.generatePeriodicLoanSchedule(body)
            .subscribe((res) => {
    ...
    onSubmit(formObj){
        ...
        let body = {
            ...
            scheduleMethodId: parseInt(this.loanData.scheduleTypeId),
            ...
            accurialBasis: parseInt(value.basis),
            integralFeeAmount: 0,
                ...
                if (res.status.isSuccessful == true) {
                    ...
                    if (res.loanPaymentSchedule.length) {
                        ...
                        let scheduleDetailsForLoanBooking = {
                            ...
                            tenor: body.tenor,
                            principalFirstpaymentDate: new Date(body.principalFirstpaymentDate),
    ...
    getLoanScheduleTypes() {
        this.loanScheduleService.getAllLoanScheduleType()
        .subscribe((res) => {
...
onEffectiveDateSelect(date){
    ...
    var maturityDate = new Date(effectiveDate.getTime() + this.tenor * 86400 * 1000);
