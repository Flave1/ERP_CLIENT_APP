  ...
  ngOnInit() {
    this.model = [
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                icon: '',
                routerLink: [
                  '/purchases-and-supplier/service-terms-setup-list',
                ],
...

      {
        label: 'PPE',
        icon: 'label',
        visible: this.roleMenuSvr.hideOrShow(['ppe'],'PPE'),
        items: [
          {
            label: 'Set Up',
            icon: 'label',
        ...
        items: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                visible: this.roleMenuSvr.hideOrShow(['translation setup']),
              },
            ],
          },
      ...
      // DEPOSITS
      {
        ...
        visible: this.roleMenuSvr.hideOrShow(['credit'], 'DEPOSIT'),
        items: [
          {
            label: 'Setup',
            icon: '',
          ...
          },
          {
            ...
            items: [
              ...
              //   label: 'Deposit',
              //   icon: '',
              //   routerLink: ['/deposit/customer-deposit'],
              //   visible: this.roleMenuSvr.hideOrShow(["credit"])
              // },
              // {
              //   label: 'Withdrawal',
              //   icon: '',
              //   routerLink: ['/deposit/customer-withdrawal'],
              //   visible: this.roleMenuSvr.hideOrShow(["credit"])
              // },
              {
              ...
              },
              {
                ...
                items: [
                  {
                    label: 'Account Reactivation List',
                    icon: '',
                    routerLink: ['/deposit/account-reactivation-list'],
                  },
                  {
                    label: 'Account Reactivation Appraisal',
                    icon: '',
                    routerLink: ['/deposit/account-reactivation-appraisal'],
                  },
                ],
              },
              {
                ...
                icon: '',
                routerLink: ['/deposit/withdrawals'],
                visible: this.roleMenuSvr.hideOrShow(['credit']),
              },
              {
      ...
      // CREDIT
      {
        label: 'Credit',
        icon: 'list',
        visible: this.roleMenuSvr.hideOrShow(['credit'], 'CREDIT'),
        items: [
          {
            label: 'Setup',
            icon: '',
      ...
      // INVESTMENT FUNDS
      {
        ...
        icon: 'list',
        visible: this.roleMenuSvr.hideOrShow(['investment fund'], 'INVESTOR'), 
        items: [
          {
            label: 'Dashboard',
            icon: '',
      ...
      // TREASURE
      {
        label: 'Treasury',
        icon: 'list',
        visible: this.roleMenuSvr.hideOrShow(['treasury'], 'TREASURY'),
        items: [
          {
            label: 'Setup',
            icon: '',
      ...
      // EXPENSE MANAGEMENT
      {
        ...
        icon: 'content_paste',
        visible: this.roleMenuSvr.hideOrShow(['admin'], 'EXPMGR'),
        items: [
          {
            label: 'Set Up',
            icon: '',
            ...
            items: [
              {
                ...
                routerLink: ['/expense-management/classification-setup-list'],
              },
              // {
              //   label: 'Out of station set up',
              //   routerLink: ['/expense-management/out-of-station-list'],
              // },
              {
                label: 'Cost centre',
                routerLink: ['/expense-management/cost-centre-list'],
              },
            ],
          },
          {
            ...
            items: [
              {
                ...
                routerLink: ['/expense-management/requisitions'],
              },
              {
                label: 'Requests',
                routerLink: ['/expense-management/requests'],
              },
              {
                label: 'Manage Expense(ERN)',
                routerLink: ['/expense-management/approved-requisitions'],
              },
              // {
              //   label: 'Retirements',
              //   routerLink: ['/expense-management/ess-retirements'],
              // },
            ],
          },
          {
            ...
            items: [
              {
                ...
                items: [
                  {
                    label: 'Expense Requisition',
                    routerLink: ['/expense-management/admin-requisition-list'],
                  },
                  {
                    label: 'ERN Approval',
                    routerLink: ['/expense-management/ern-approval'],
                  },
                  {
                    label: 'Approved ERN',
                ...
                items: [
                  {
                    ...
                    routerLink: ['/expense-management/payment-proposal'],
                  },
                  {
                    label: 'Payment Approval',
                    routerLink: ['/expense-management/payment-approval'],
                  },
                ],
              },
              {
                label: 'Retirement',
                routerLink: ['/expense-management/retirements'],
              },
              {
                label: 'Claims',
                icon: '',
                items: [
                  {
                    label: 'Non-Requisition Claims',
                    routerLink: ['/expense-management/claims'],
                  },
                  {
                    label: 'Claims Approval',
                    routerLink: ['/expense-management/req-claim-approval'],
                  },
                  // {
                  //   label: 'Non-Requisition Claims Approval',
                  //   routerLink: ['/expense-management/claims-approval'],
                  // },
                ],
              },
              {
                label: 'Collections',
                icon: '',
                routerLink: ['/expense-management/collections'],
              },
            ],
          },
        ],
...
export class AppSubMenuComponent {
  ...
  constructor(public app: MainLayoutComponent) {}
