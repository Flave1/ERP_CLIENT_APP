...
export class CustomerRegistrationComponent implements OnInit {
  ...
  getLoanCustomerIdentityDetailsByLoanCustomer(customerId) {
    this.loanCustomerService
      .getLoanCustomerIdentityDetailsByLoanCustomer(customerId)
      .subscribe(data => {
        this.loanCustomerIdentityDetails = data["result"];
      });
  }
  ...
  editDepositCustomer(customerId) {
    this.formTitle = "Add Customer Information";
    this.loadingService.show();
  ...
  submitLoanCustomerInfo(formObj) {
    ...
    payload.cityId = parseInt(payload.cityId);
  ...
  deleteIdentityDetails(row) {
    swal
      .fire({
        title: "Are you sure you want to delete recor?",
        text: "You won't be able to revert this",
        icon: "warning",
        showCancelButton: true,
        confirmButtonText: "Yes!"
  ...
  showAddNewDirectorShareHolders() {
    ...
    this.directorShareHolderForm.reset()
  }
