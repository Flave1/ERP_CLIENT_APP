...
@Component({
  selector: "app-liquidation-appraisal",
  templateUrl: "./liquidation-appraisal.component.html",
  styleUrls: ["./liquidation-appraisal.component.css"]
})
export class LiquidationAppraisalComponent implements OnInit {
  ...
  getLiquidationApprovals() {
    ...
    this.investorFundService.liquidationAppraisal().subscribe(
      data => {
